...
class SimpleAvoidMovement(Movement):
    ...
    def position(self, data, robot):
        ...
        # print info
        SimpleAvoidMovement.print_info(False, velocity_vector, object_vector, threshold, turn_direction,
...
class RunMovement(Movement):
    ...
    def position(self, data, robot):
        ...
        threat_angle = SimpleAvoidMovement.calculate_angle_between_vectors(threat_coordinates, x, y, v, alpha)
        ...
        # set Threshold
        threshold = RunMovement.calculate_threshold(obj_type, v, alpha, v_alpha, v_max, robot)

        # getting information about angle and direction
        turn_direction = SimpleAvoidMovement.calculate_direction(object_vector, velocity_vector)
        threat_turn_direction = SimpleAvoidMovement.calculate_direction(threat_vector, velocity_vector)
...
class ChaseMovementGun(Movement):
    ...
    def position(self, data, robot):
        ...
        if type(target_bot) == bool:
            ...
            a, a_alpha = ChaseMovementGun.position_destination_robot(self, data, robot)
            robot.destination = None
